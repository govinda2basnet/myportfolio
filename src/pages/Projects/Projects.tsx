...
const projects: iProject[] = [
  {
    id: 0,
    title: 'CV Manager',
    description: "Manages CV of Applicant",
    imgUrl: images.LashShack,
    tags: [ Tag.React, Tag.Firebase, Tag.AntDesign ],
    links: [
      {
        link: Link.Github,
        url: "https://github.com/govinda2basnet/cv-manager-app.git"
      },
    ],
  },
  {
    ...
    description: "Online store for ladies,gents and many more",
    imgUrl: images.Pallion_Mern,
    tags: [ Tag.React, Tag.NodeJS, Tag.AntDesign,  ],
    links: [
      {
        link: Link.Github,
        url: "https://github.com/govinda2basnet/e-commerce.git"
      }
    ]
  },
  {
    id: 2,
    title: 'Utkristha Foto',
    description: "Finding Videographer and photographer",
    imgUrl: images.Pallion_RF,
    tags: [ Tag.React, Tag.Firebase ],
    links: [
      {
        link: Link.URL,
        url: "https://github.com/govinda2basnet/utkrista-foto.git"
      }
    ]
  },
  {
