...
const About: React.FC = () => {
    ...
    return (
        <Page id='about' className='app__about app__page--padtop' pageTitle='.aboutMe();'>
            ...
            <div className="bio">
                <div className="info">
                    <p className='app__about--text'>Hello! My name is Govinda Basnet, I am a Frontend  developer who is passionate about Designing a Responsive User-interface and related. Also Interested in Graphics Designing using Adobe illustrations and Photoshop.</p><br />
                    ...
                    <p className='app__about--text'>I am currently looking for an opportunity to work with a Javascript framework and Libraries. Ultimately, I aim to find a position that allows me to use new technologies.</p><br />
                    <p className='app__about--text'>In my spare time when I am not busy building apps, I like to take long walks and drives while exploring new places around Beautiful Himalayas.</p><br />
                </div>
